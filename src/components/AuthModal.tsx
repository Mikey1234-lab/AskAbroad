...
import { X, Eye, EyeOff, User, Phone, MessageCircle, UserX, Users, Mail, Check } from 'lucide-react';
              ...
              <div className="mt-6 text-center">
                <div className="bg-orange-50 rounded-xl p-4">
                  <p className="text-sm text-orange-700">
                    As a guest, you can send up to 5 messages. Sign up anytime for unlimited access to all features.
                  </p>
                </div>
              </div>
            </div>
